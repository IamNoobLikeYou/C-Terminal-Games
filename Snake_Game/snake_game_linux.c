// Cross-Platform Enhanced Snake Game with Colors, Shop, and Menus
// For Windows: gcc snake_enhanced.c -o snake_enhanced.exe
// For Linux: gcc snake_enhanced.c -o snake_enhanced -lncurses
...
void show_intro() {
    ...
    while (get_key() != -1) sleep_ms(10); // Clear buffer
...
void show_shop() {
    ...
    for (int i = 0; i < 10; i++) {
        ...
        printf("[%d] %s", (i + 1) % 10, snakes[i].name);
    ...
    set_color(15);
    set_cursor_position(5, y + 1);
    printf("Press 1-9, 0 for snake 10 to buy/select | ESC/Q to return");
    set_color(7);
    fflush(stdout);
